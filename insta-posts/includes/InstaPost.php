...
class InstaPost {
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/InstaPost_Admin.php';
		...
		$this->loader = new InstaPost_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new InstaPost_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new InstaPost_Admin( $this->get_plugin_name(), $this->get_version() );
